...
export default function VehicleAvailability({
    ...
    if (isVehicleRootPage) {
        ...
        return (
          ...
          ================================================== */}
                    ...
                    {visibleCities.map((citySlug) => {
                        const cityRoutes = vehicleRoutes.filter(
                            (route) => route.citySlug === citySlug
                        );

                        const uniqueCityRoutes = Array.from(
                            new Map(
                        ...
                        const displayedRoutes = expandedCities[citySlug]
                            ? uniqueCityRoutes
                            : uniqueCityRoutes.slice(0, 12);
        ...
        "
            ...
            "
                                        >
                                            {expandedCities[citySlug]
                                                ? "Show Less"
                                                : `View all ${uniqueCityRoutes.length} routes from ${makeName(
                                                    citySlug
                                                )}`}

                                            <span
                                                className={`transition-transform ${expandedCities[citySlug]
                                                        ? "rotate-180"
                                                        : ""
                                                    }`}
                                            >
          ...
          ================================================== */}
                ...
                "
                            >
                                ...
                                <span
                                    className={`transition-transform ${showAllCities
                                            ? "rotate-180"
                                            : ""
                                        }`}
                                >
              ...
              "
                  ...
                  "
                                        >
                                            ...
                                            <span
                                                className={`transition-transform ${showAllRoutes
                                                        ? "rotate-180"
                                                        : ""
                                                    }`}
                                            >
