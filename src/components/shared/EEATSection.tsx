    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            WHY TRUST CHIKU CABS
          </div>
          <h2 className="section-title">
            India's Most Trusted {vehicle || "Cab"} Service
            {city ? ` in ${city}` : ""} Since 2015
          </h2>
          <p className="section-subtitle mx-auto" style={{ maxWidth: "48rem" }}>
            With over <strong>1 Lakh+ completed trips</strong> across{" "}
            <strong>100+ cities</strong>, Chiku Cabs has earned the trust of
            families, corporates, and travelers nationwide.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="premium-card bg-card border shadow-sm">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center text-2xl bg-primary/10 text-primary">
                🏆
              </div>
              <div>
                <h3 className="text-xl font-bold">10+ Years Experience</h3>
                <p className="text-sm font-medium text-muted-foreground mt-1">
                  Serving travelers since 2015
                </p>
              </div>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Founded in 2015, Chiku Cabs started with a small fleet in
              Delhi-NCR and has grown into one of India's most reliable cab
              services. Our decade-long experience means we understand what
              travelers need — clean vehicles, punctual drivers, transparent
          ...
          <div className="premium-card bg-card border shadow-sm">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Every Chiku Cabs driver undergoes police verification, license
              validation, and driving skill assessment. Our drivers are trained
              in safe driving, customer etiquette, and first aid.
              {city
                ? ` Our ${city}-based drivers know every route, shortcut, and local landmark.`
                : ""}
            </p>
          </div>
          ...
          <div className="premium-card bg-card border shadow-sm">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              All vehicles are GPS-tracked in real-time. Get a detailed fare
              breakdown before booking — driver allowance, fuel, tolls, and GST
              clearly stated. Free cancellation up to 24 hours before pickup. We
              carry passenger insurance for every trip.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-2 bg-white border border-border/60 shadow-sm rounded-full px-5 py-2.5 hover:border-primary/30 hover:shadow-md transition-all"
            >
          ...
          <div className="bg-card rounded-3xl shadow-xl border border-border p-8 md:p-12">
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              <div className="lg:col-span-7 xl:col-span-8">
                ...
                <div className="prose prose-sm max-w-none text-muted-foreground space-y-4">
                  ...
                  <p className="text-base leading-relaxed">
                    ...
                    affordable, safe, and stress-free for every Indian family.
                    {city
                      ? ` We have a dedicated fleet and driver network in ${city} to serve you with local expertise and care.`
                      : ""}
                  </p>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 xl:col-span-4 bg-muted/30 rounded-2xl p-6 md:p-8 border border-border/50 w-full">
                <h4 className="font-bold text-lg mb-6 border-b pb-4">
                  Contact Information
                </h4>
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <span className="text-muted-foreground leading-relaxed">
                        Noida Sector 2, Uttar Pradesh 201301
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
