...
export default function TempoTravellerServiceTemplate({
  parsedData,
}: {
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
          <div className="flex-1">
            <div className="section-badge">
              🚐 INDIA'S #1 TEMPO TRAVELLER RENTAL
            </div>
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8 max-w-xl">
              Perfect for group trips, weddings, and corporate outings.
              Experience seamless <strong>tempo traveller booking</strong> and
              get the best <strong>tempo traveller on rent</strong> with
              pushback reclining seats, AC, and a top-rated{" "}
              <strong>group travel service</strong> experience for your entire
              group.
            </p>
          ...
          <div className="flex-1 w-full" style={{ maxWidth: "32rem" }}>
            <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-white aspect-[16/9]">
              <img
                ...
                alt={`Tempo Traveller on Rent in ${city !== "India" ? city : "India"} by Chiku Cabs`}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="section-subtitle mx-auto">
              Every variant comes with AC, pushback seats, luggage carrier &
              music system.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              {
                seats: "26 Seater",
                model: "Force Traveller / Bus",
                price: "₹28/km",
                best: false,
                features: [
                  "26 Comfortable Seats",
                  "Maximum Capacity",
                  "AC + Entertainment",
                  "Pilgrimages & Tours",
                ],
            ...
            {[
              {
                icon: "🛕",
                title: "Pilgrimages",
                desc: "Char Dham, Vaishno Devi, Golden Temple & more",
              },
              {
                icon: "💒",
                title: "Weddings",
                desc: "Baarat pickup, guest transfers & family travel",
              },
              {
                icon: "🏔️",
                title: "Hill Stations",
                desc: "Manali, Shimla, Nainital, Mussoorie trips",
              },
              {
                icon: "🏢",
                title: "Corporate Outings",
                desc: "Team outings, offsites & retreats",
              },
              {
                icon: "🎓",
                title: "School/College Trips",
                desc: "Educational tours & excursions",
              },
              {
                icon: "✈️",
                title: "Airport Transfers",
                desc: "Large group airport pickups & drops",
              },
            ].map((useCase, i) => (
      ...
      <section className="bg-muted/30 py-24 border-y">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="section-title">
              Book Your Tempo Traveller {city !== "India" ? `in ${city}` : ""}{" "}
              in 3 Steps
            </h2>
            <div className="section-divider mx-auto"></div>
          </div>
            ...
            {[
              {
                ...
                desc: "Tell us your group size, pickup city, destination, and travel dates via call or WhatsApp.",
              },
              {
                num: "2",
                icon: "🚐",
                title: "Choose Your Tempo",
                desc: "Pick from 12, 16, 20, or 26 seater based on your group size and budget.",
              },
              {
                num: "3",
                icon: "✅",
                title: "Confirm & Travel",
                desc: "Get instant confirmation. Your dedicated Tempo Traveller arrives at your doorstep.",
              },
            ].map((step, i) => (
          ...
          {[
            {
              ...
              a: `We offer 12 seater, 16 seater, 20 seater, and 26 seater tempo traveller on rent in ${city}. All options come with AC, pushback reclining seats, and ample luggage space.`,
            },
            {
              q: `How much does a tempo traveller booking cost per day in ${city}?`,
              a: `Pricing for tempo traveller booking in ${city} starts from ₹18/km. Total cost depends on distance, duration, and the seating capacity you choose.`,
            },
            {
            ...
            },
            {
              ...
              a: `The per km rate for tempo traveller booking starts at ₹18. Use our app or call 8448445504 for a transparent quote for your ${city} itinerary.`,
            },
            {
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 mb-10">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Plan weekend getaways securely with our verified commercial{" "}
                    <strong>tempo traveller service</strong> drivers.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1 text-xl">✔</span>
              ...
              <div className="bg-card p-8 rounded-2xl border shadow-sm mt-8">
                <p className="mb-0 text-card-foreground">
                  Booking your{" "}
                  <strong>tempo traveller on rent in {city}</strong> is easy via
                  our <strong>tempo traveller booking</strong> app. We offer
                  100% transparent pricing for both local and{" "}
                  <strong>outstation tempo traveller</strong> trips from {city}.
                </p>
              </div>
            </div>
          </div>
